...
export default function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>NatureFarm — Fresh Vegetables &amp; Fruits</title>
      ...
      <main className="min-h-screen bg-gradient-to-b from-green-600 to-green-800 flex flex-col items-center justify-between p-6">
        ...
        <div className="w-full max-w-sm flex flex-col gap-4 pb-8">
          <button
            ...
            className="w-full bg-white text-green-700 font-bold text-xl py-5 rounded-2xl shadow-xl active:scale-95 transition-all duration-150 flex items-center justify-center gap-3"
          >
          ...
          <button
            ...
            className="w-full bg-white/15 hover:bg-white/25 border-2 border-white/40 text-white font-semibold text-lg py-4 rounded-2xl backdrop-blur-sm active:scale-95 transition-all duration-150 flex items-center justify-center gap-3"
          >
