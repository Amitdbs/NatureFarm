...
export default function OrderPage() {
  ...
  function validate(): boolean {
    ...
    if (!contact.trim()) newErrors.contact = t("required_field");
      ...
      newErrors.contact = t("invalid_contact");
      ...
      <main className="min-h-screen bg-green-50 flex flex-col items-center justify-center p-6">
        <div className="w-full max-w-sm">
          <div className="card text-center py-10">
            ...
            <Link href="/">
              <button className="btn-secondary mt-3">← {t("app_name")}</button>
            </Link>
          </div>
        </div>
      </main>
  ...
  return (
    <main className="min-h-screen bg-green-50 pb-8">
      ...
      <div className="bg-green-600 text-white px-4 py-4 flex items-center gap-3 sticky top-0 z-10 shadow-md">
        <Link href="/" className="text-white/80 hover:text-white text-xl leading-none">
          ←
        </Link>
            ...
            {loadingProducts ? (
              ...
              <div className="space-y-4">
                {items.map((item, index) => (
                  <div
                    key={index}
                    className="bg-green-50 border border-green-100 rounded-xl p-3 space-y-2"
                  >
                    ...
                    <div>
                      ...
                      >
                        ...
                        {(filter === "all" ? activeProducts : filteredProducts)
                          .map((p) => (
